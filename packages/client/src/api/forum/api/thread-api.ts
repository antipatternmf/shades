...
// @ts-ignore
import { AllThreadsDto } from '../models';
// @ts-ignore
...
export const ThreadApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    deleteThread: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/thread/{id}`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
...
export const ThreadApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async addThread(
      createThreadDto?: CreateThreadDto,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ThreadType>> {
    ...
    async getAllThreads(
      ...
      title?: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AllThreadsDto>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getAllThreads(
        offset,
        limit,
        title,
        options,
...
export const ThreadApiFactory = function (
  ...
  return {
    ...
    addThread(createThreadDto?: CreateThreadDto, options?: any): AxiosPromise<ThreadType> {
      return localVarFp
        .addThread(createThreadDto, options)
    ...
    getAllThreads(
      ...
      title?: string,
      options?: any,
    ): AxiosPromise<AllThreadsDto> {
      return localVarFp
        .getAllThreads(offset, limit, title, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    updateThread(
      ...
      createThreadDto?: CreateThreadDto,
      options?: any,
    ): AxiosPromise<ThreadType> {
      return localVarFp
        .updateThread(id, createThreadDto, options)
        .then((request) => request(axios, basePath));
    },
  };
};
