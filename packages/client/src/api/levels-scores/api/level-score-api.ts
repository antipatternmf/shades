...
export const LevelScoreApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    getLevelScores: async (
      username: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'username' is not null or undefined
      assertParamExists('getLevelScores', 'username', username);
      const localVarPath = `/level-score/{username}`.replace(
        `{${'username'}}`,
     ...
     * @throws {RequiredError}
     */
    saveLevelScore: async (
      saveLevelScoreDto?: SaveLevelScoreDto,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      const localVarPath = `/level-score`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const LevelScoreApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async deleteLevelScore(
      username: string,
      levelId: number,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LevelScoreDto>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteLevelScore(
        username,
        levelId,
        options,
      );
    ...
    async getAllTotals(
      ...
      limit?: number,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AllTotalsDto>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getAllTotals(
        offset,
        limit,
        options,
      );
    ...
    async getLevelScores(
      username: string,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<LevelScoreDto>>> {
     ...
     * @throws {RequiredError}
     */
    async saveLevelScore(
      saveLevelScoreDto?: SaveLevelScoreDto,
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LevelScoreDto>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.saveLevelScore(
        saveLevelScoreDto,
        options,
      );
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
 ...
 * @export
 */
export const LevelScoreApiFactory = function (
  ...
  return {
    ...
    deleteLevelScore(
      ...
      levelId: number,
      options?: any,
    ): AxiosPromise<LevelScoreDto> {
      return localVarFp
        .deleteLevelScore(username, levelId, options)
    ...
    getAllTotals(offset?: number, limit?: number, options?: any): AxiosPromise<AllTotalsDto> {
      return localVarFp
        .getAllTotals(offset, limit, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getLevelScores(username: string, options?: any): AxiosPromise<Array<LevelScoreDto>> {
      return localVarFp
        .getLevelScores(username, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    saveLevelScore(
      ...
      return localVarFp
        .saveLevelScore(saveLevelScoreDto, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export interface LevelScoreApiInterface {
  ...
  getLevelScores(
    username: string,
    options?: AxiosRequestConfig,
  ): AxiosPromise<Array<LevelScoreDto>>;
...
export class LevelScoreApi extends BaseAPI implements LevelScoreApiInterface {
  ...
  public deleteLevelScore(username: string, levelId: number, options?: AxiosRequestConfig) {
    return LevelScoreApiFp(this.configuration)
      .deleteLevelScore(username, levelId, options)
